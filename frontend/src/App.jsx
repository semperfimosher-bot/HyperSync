...
function HomePosterMark() {
  return (
    <svg
      className="home-poster__mark"
      viewBox="0 0 440 440"
      role="img"
      aria-label="HyperSync metallic H lightning logo"
    >
      <defs>
        <linearGradient
          id="home-poster-metal-left"
          x1="0"
          y1="0"
          x2="1"
          y2="0"
      ...
      <g filter="url(#home-poster-shadow)">
        <path
          d={
            "M69 64 " +
            "L178 18 " +
          ...
          fill="url(#home-poster-metal-left)"
          stroke="#eaf2f5"
          strokeOpacity="0.54"
          strokeWidth="2"
          filter="url(#home-poster-metal-texture)"
        />
        ...
        <path
          ...
          fill="url(#home-poster-metal-right)"
          stroke="#eaf2f5"
          strokeOpacity="0.5"
          strokeWidth="2"
          filter="url(#home-poster-metal-texture)"
      ...
      <g filter="url(#home-poster-blue-glow)">
        <path
          d={
            "M287 3 " +
            "L133 221 " +
        ...
        <path
          ...
          fill="none"
          stroke="url(#home-poster-bolt-highlight)"
          strokeWidth="3"
          strokeLinejoin="round"
        />
      </g>
      ...
      <g
        fill="none"
        stroke="url(#home-poster-blue-streak)"
        strokeLinecap="round"
        filter="url(#home-poster-blue-glow)"
      >
        <path
          d="M280 25C246 80 198 142 157 206"
          strokeWidth="4"
        />

        <path
          d="M303 64C267 112 228 163 196 209"
          strokeWidth="2.5"
          opacity="0.75"
        />

        <path
          d="M155 239C126 292 104 337 84 384"
          strokeWidth="3"
          opacity="0.8"
        />

        <path
          d="M317 174C345 142 367 122 397 105"
          strokeWidth="2.5"
          opacity="0.55"
        />

        <path
          d="M190 192C152 166 121 151 90 146"
          strokeWidth="2"
          opacity="0.38"
        />
      </g>
...
function HomePage({
  ...
  return (
    <div className="page-stack home-page">
      <section className="home-poster bevel-panel">
        <div
          className="home-poster__hexes"
          aria-hidden="true"
        />

        <div
          className="home-poster__blue-edge home-poster__blue-edge--one"
          aria-hidden="true"
        />

        <div
          className="home-poster__blue-edge home-poster__blue-edge--two"
          aria-hidden="true"
        />

        <div
          className="home-poster__art"
          aria-hidden="true"
        >
          <HomePosterMark />
        </div>

        <div className="home-poster__wordmark">
          <span className="home-poster__wordmark-metal">
            HYPER
          </span>

          <span className="home-poster__wordmark-blue">
            SYNC
          </span>
        </div>
      </section>
      ...
      <div className="home-poster-actions">
        ...
        <span className="home-poster-actions__guest">
          <i aria-hidden="true" />
