...
def upgrade() -> None:
    ...
    sa.Column('account_type', sa.Enum('guest', 'registered', name='account_type', native_enum=False, create_constraint=True), server_default='guest', nullable=False),
    sa.Column('email', sa.String(length=320), nullable=True),
    sa.Column('username', sa.String(length=32), nullable=True),
    sa.Column('username_normalized', sa.String(length=32), nullable=True),
    sa.Column('password_hash', sa.String(length=255), nullable=True),
    sa.Column('role', sa.Enum('user', 'admin', name='user_role', native_enum=False, create_constraint=True), server_default='user', nullable=False),
